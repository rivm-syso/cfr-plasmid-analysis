...
Conda environments used for analysis in the manuscript can be found in the `envs` folder.

## Data

### Data availability

Pseudonymized metadata from the national surveillance is made available as supplementary data in the manuscript.
raw sequencing data and/or assemblies are available through NCBI.
